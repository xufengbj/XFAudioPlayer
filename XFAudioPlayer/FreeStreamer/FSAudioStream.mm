...
- (id)init
{
    ...
    if (self) {
        ...
        self.maxPrebufferedByteCount = 100000000; // 100 MB
#else
        self.maxPrebufferedByteCount = 100000000; // 1 MB
#endif
        ...
        self.enableTimeAndPitchConversion = YES;
        ...
        self.requiredInitialPrebufferedByteCountForContinuousStream = 256000000;
        self.requiredInitialPrebufferedByteCountForNonContinuousStream = 256000000;
